...
(DIRECCION, CIUDAD, PISCINA, JACUZZI, SAUNA, MASAJES, TURCO, JUEGOS, PLAYA, BAR, DISCOTECA)
VALUES
('Calle 1B', 'Cali', 0, 0, 1, 0, 1, 1, 0, 0, 1);
...
(ID, CLIENTE, HOTEL, FECHA, VALOR, TEMPORADAL)
AS
SELECT R.ID, R.CLIENTE, R.HOTEL, R.FECHA, R.VALOR, R.TEMPORADAL FROM RESERVAS R

-- 4.3 Asignamos permisos para acceder a las vistas del Schema Owner
GRANT SELECT ON GET_CLIENTES_POR_HOTEL TO GERENCIA;
...
GRANT SELECT ON GET_CLIENTES_POR_HOTEL TO RECEPCION;
